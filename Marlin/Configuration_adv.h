...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5 Plus" //R
 ...
 */
#define USE_CONTROLLER_FAN //R
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN  PB15           // Set a custom pin for the controller fan //R
  //#define CONTROLLER_FAN2_PIN -1          // Set a custom pin for second controller fan
  //#define CONTROLLER_FAN_USE_Z_ONLY       // With this option only the Z axis is considered
  //#define CONTROLLER_FAN_IGNORE_Z         // Ignore Z stepper. Useful when stepper timeout is disabled.
  #define CONTROLLERFAN_SPEED_MIN         0 // (0-255) Minimum speed. (If set below this value the fan is turned off.) //R
  #define CONTROLLERFAN_SPEED_ACTIVE    255 // (0-255) Active speed, used when any motor is enabled //R
  #define CONTROLLERFAN_SPEED_IDLE        0 // (0-255) Idle speed, used when motors are disabled //R
  #define CONTROLLERFAN_IDLE_TIME       120 // (seconds) Extra time to keep the fan running after disabling motors //R
...
#define COOLER_AUTO_FAN_TEMPERATURE 18 //R
#define COOLER_AUTO_FAN_SPEED 255 //R
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 180,  20 }, { 180, 180 }, { 20, 180 } } //R
...
#define INPUT_SHAPING_Y //R
    ...
    #define SHAPING_ZETA_X  0.15f // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping). //R
  #endif
  #if ENABLED(INPUT_SHAPING_Y) //R
    #define SHAPING_FREQ_Y  16.72    // (Hz) The default dominant resonant frequency on the Y axis. //R
    #define SHAPING_ZETA_Y  0.15f // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping). //R
  #endif
 ...
 */
#define LIN_ADVANCE //R
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0 }     // (mm) Compression length per 1mm/s extruder speed, per extruder //R
  #else
    #define ADVANCE_K 0         // (mm) Compression length applying to all extruders //R
  #endif
...
// G2/G3 Arc Support
//
#define ARC_SUPPORT                   // Requires ~3226 bytes //R
 ...
 */
#define ADVANCED_PAUSE_FEATURE //R
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current. //R
  ...
  #define X_HYBRID_THRESHOLD     300  // [mm/s] //R
  ...
  #define I_HYBRID_THRESHOLD       4  // [linear=mm/s, rotational=°/s]
  #define J_HYBRID_THRESHOLD       4  // [linear=mm/s, rotational=°/s]
  #define K_HYBRID_THRESHOLD       4  // [linear=mm/s, rotational=°/s]
  #define U_HYBRID_THRESHOLD       4  // [mm/s]
  #define V_HYBRID_THRESHOLD       4
  #define W_HYBRID_THRESHOLD       4
